...
public class newat 
{
	...
	private static int uid=4321;// Userid
	private static int pi=1234;// User PIN
    ...
    public static void main(String[] args) 
    {
	    ...
	    System.out.println("Enter the Secreat PIN");
   ...
   private static void withdraw() {
    ...
    private static void transfer() 
    {
        ...
        {
            balance -= amount;
            System.out.println("Transfer successful.Accoiunt No.:"+a+ "Current balance: Rs" + balance);
        } 
        else if (amount <= 0) 
        {
            System.out.println("Invalid amount. Please enter a positive amount.");
